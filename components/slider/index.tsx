...
export function CarouselSlider({ ObjUrls }: { ObjUrls: any }) {
    ...
    const CustomButtonGroup = ({ next, previous }: any) => {
        return (
            <div className="w-[calc(100%+40px)] h-10 mt-2 flex justify-between -ml-[20px]">
    ...
    return <div className="h-full w-full">
        ...
        <Carousel
            ...
            containerClass="w-full h-60 rounded-2xl mt-2 outline outline-[1px] outline-gray-300 bg-white dark:bg-[#242526]"
            rewind={true}
        ...
        >
            ...
            {ObjUrls.length != 0 ? ObjUrls.map((url: any, index: any) => (
